  ...
  return (
    <>
        <div className="bg-[#F3F3F2] hidden md:block">
            <WidthWrapper className="flex py-0 items-center justify-between">
                <Link href={"/"}>
                    <Image
                        src='/logo.svg'
                        alt='logo'
                ...
                <div className="flex gap-5">
                    <Button
                        variant={"outline"}
                        size={"sm"}
                        className="rounded-[8px] px-3 py-5 border border-[#D5D5D5] text-[#2B2B2B] bg-white hover:bg-[#CE9F41] hover:text-white cursor-pointer" 
                    >
                        Contact
                    </Button>
                    <Button
                        variant={"outline"}
                        size={"lg"}
                        className="rounded-[8px] px-3 py-5 border border-[#D5D5D5] text-white bg-[#CE9F41] hover:bg-[#F7F6F3] hover:text-[#2B2B2B] cursor-pointer" 
                    >
                        Wholesale Enquiry
                    </Button>
                </div>
