    ...
    const works = [
        {
            ...
            description: "Our seamstresses work at our central sowing center in Lalitpur - our central hub and home to our sowing machinery!"
        },
        {
            icon: <Sewing />,
            title:"Home Weavers",
            description: "Home weavers with mobility limitations work from home, with regular local gatherings for support and training."
        },
    ]
    ...
    <>
        <div className='relative w-full'>
            ...
            <div className='absolute inset-0 z-10 flex items-center px-6 sm:px-10 md:px-16 lg:px-24'>
                <h4 className='font-semibold text-3xl sm:text-4xl md:text-5xl text-white leading-[60px]'>About Us</h4>
            </div>
        </div>
        <div className='products-bg mt-10'>
            <HeroWrapper>
                <div className='text-left md:text-center mb-15'>
                    <h4 className='font-medium text-3xl md:text-4xl mb-10'>It all began with reusable diapers...</h4>
                    <p className='text-[#2B2B2B] text-lg font-light max-w-4xl mx-auto leading-[28px]'>
                    Jyoti began in 2018 as &quot;Babu&apos;s Bum&quot; with a vision to empower Nepali women with barriers to employment with a great job making re-usable diapers. As our team has grown, we now offer a range of pre-made and made-to-order handmade and customizable fabric products for sale in Nepal and around the world.
                    </p>
                </div>
                <div>
                    <h4 className=' text-left md:text-center font-medium text-3xl md:text-4xl mb-7'>The Jyoti team works across the Kathmandu Valley</h4>                    
                </div>
                <div className='flex justify-center gap-10 md:gap-15 flex-wrap mb-15'>
                    {works.map((work,index)=> (
                        <div key={index} className='space-y-3 bg-[#FFFFFF] border border-[#EAEAEA] rounded-md work-shadow p-5 max-w-sm' >
                ...
                <StorySection
                    ...
                    imageSrc="/about2.png"
                    imageAlt="About us"   
                    buttonLogo={ [<FaInstagram key="instagram" />, <LuFacebook key="facebook" />] }   
